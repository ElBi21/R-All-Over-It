...
First, before starting, we must install and import the necessary libraries: - `duckdb`: a SQL database; - `dplyr`: a library for data manipulation; - `ggplot2`: a library used to plot data.
